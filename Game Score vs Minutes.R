...
team_stats <- read.csv("C:\\Users\\Bryce Haase\\Desktop\\UMass Basketball\\Minutes vs Game Score.csv")
...
ggplot(team_stats, aes(Gscore, Minutes)) +
  ...
  labs(x = "Game Score",
       y = "Minutes",
       title = "The Impact of Sahvir Wheeler",
       subtitle = "Wheeler's Minutes vs. Kentucky's Game Score\nGame Score: Game Performance Rating from 0-100")

ggsave("Wheeler GScore.png", w = 6, h = 6, dpi = 300, type = 'cairo')