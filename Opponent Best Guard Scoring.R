...
bart_player_stats %>%
  ...
  cols_label(player = "Player",
             ...
             diff = "Diff") %>%
  tab_header(
    title = "UMass vs Scoring Guards",
    subtitle = "Points Allowed vs Guards in Losses"
  )  %>%
  # text_transform(
...
data_color(
  ...
  gtsave("C:\\Users\\Bryce Haase\\Desktop\\UMass Basketball\\Best Players Guards.png", expand = 0)
