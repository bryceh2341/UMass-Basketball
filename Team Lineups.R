...
#twoman <- get_player_combos(Lineup_Data = get_lineups(play_by_play_data = get_play_by_play(team_schedule$Game_ID), include_transition = T),n = 2,include_transition = T, min_mins = 0)
#threeman <- get_player_combos(Lineup_Data = get_lineups(play_by_play_data = get_play_by_play(team_schedule$Game_ID), include_transition = T),n = 3,include_transition = T, min_mins = 0)
